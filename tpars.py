...
async def normal_handler(event):
    ...
    webhook = DiscordWebhook(
        url='https://discord.com/api/webhooks/1080470684079231006/usZW9YRn7tya0PvIVKVyTGyAAAmKnKgKsTpZPoZRU0wAm_eYKrI0Wnl8hsJnyJK3fDzq',
        content=message)
...
async def normal_handler(event):
    ...
    message = result
    webhook = DiscordWebhook(
        url='https://discord.com/api/webhooks/1080470481087516733/w_4AvaSOXqZwx0mXaDcPL0G4r6QETA0qFGKn9JtrDKbHKlFFjsPAwD2mXQxIYIeIwuz1',
        content=message)
    response = webhook.execute()
...
async def normal_handler(event):
    ...
    message = result
    webhook = DiscordWebhook(
        url='https://discord.com/api/webhooks/1069336217033916466/S1CtrdaxmWCJ0fe7bHNI3y9JUMFkptE41QKbuuAqJgZZ4BNuJtOpqQ2thUQk-dsrd4D4',
        content=message)
    response = webhook.execute()
